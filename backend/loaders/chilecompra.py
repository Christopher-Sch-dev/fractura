...
DATA_ROOT = Path(os.getenv("LOCAL_DATA_PATH", str(Path(__file__).parent.parent.parent / "fractura_research" / "fractura-local-data" / "raw" / "chilecompra")))
